...
public class Data {
    ...
    String[] gyeongi = {"가평군", "고양시", "과천시", "광명시", "광주시", "구리시",
    ...
    String[] busan = {"강서구", "금정구", "기장군", "남구", "동구", "동래구",
            "부산진구", "북구", "사상구", "사하구", "서구",
            "수영구", "연제구", "영도구", "중구", "해운대구"};
    String[] daegu = {"남구", "달서구", "달성군", "동구", "북구", "서구",
            "수성구", "중구"};
    String[] incheon = {"강화군", "계양구", "남구", "남동구", "동구",
    ...
    String[] chungbook = { "괴산군", "단양군", "보은군", "영동군", "옥천군", "음성군",
            "제천시", "증평군", "진천군", "청원구", "청주시", "충주시"};
    String[] chungnam = {"계룡시", "공주시", "금산군", "논산시", "당진시", "보령시",
    ...
    String[] gyeongbuk = {"경산시", "경주시", "고령군", "구미시", "군위군", "김천시",
            ...
            "의성군", "청도군", "청송군", "칠곡군", "포항시"};
    String[] gyeongnam = {"거제시", "거창군", "고성군", "김해시", "남해군", "밀양시",
            "사천시", "산청군", "양산시", "의령군", "진주시", "창녕군",
            "창원시", "통영시", "하동군", "함안군", "함양군", "합천군"};
    String[] kangwon = {"강릉시", "고성군", "동해시", "삼척시", "속초시", "양구군",
